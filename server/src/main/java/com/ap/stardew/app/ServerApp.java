...
public class ServerApp {
    ...
    public static void removeClientConnection(ClientConnection clientConnectionThread) {
    ...
    public static void addClientConnection(ClientConnection clientConnectionThread) {
