...
public class CharacterSpriteManager {
    ...
    private void loadAnimations() {
        loadWalkAnim(Direction.DOWN , Player.Action.WALKING , "0@90, 1@60, 18@120, 1@60, 0@90, 2@60, 19@120, 2@60");
        loadWalkAnim(Direction.UP   , Player.Action.WALKING , "12@90, 13@60, 22@120, 13@60, 12@90, 14@60, 23@120, 14@60");
        loadWalkAnim(Direction.RIGHT, Player.Action.WALKING , "6@90, 21@140, 17@100, 6@90, 20@140, 11@100");
        loadWalkAnim(Direction.LEFT , Player.Action.WALKING , "6@90, 21@140, 17@100, 6@90, 20@140, 11@100");

        loadWalkAnim(Direction.DOWN , Player.Action.HARVESTING , "54@100, 55@100, 56@100, 57@100");
        loadWalkAnim(Direction.UP   , Player.Action.HARVESTING , "62@100, 63@100, 64@100, 65@100");
        loadWalkAnim(Direction.RIGHT, Player.Action.HARVESTING , "58@100, 59@100, 60@100, 61@100");
        loadWalkAnim(Direction.LEFT , Player.Action.HARVESTING , "58@100, 59@100, 60@100, 61@100");

        loadWalkAnim(Direction.DOWN , Player.Action.USING_TOOL , "66@150, 67@40, 68@40, 69@170, 70@75");
        loadWalkAnim(Direction.UP   , Player.Action.USING_TOOL , "36@100, 37@40, 38@40, 63@220, 62@75");
        loadWalkAnim(Direction.RIGHT, Player.Action.USING_TOOL , "48@100, 49@40, 50@40, 51@220, 52@75");
        loadWalkAnim(Direction.LEFT , Player.Action.USING_TOOL , "48@100, 49@40, 50@40, 51@220, 52@75");

        loadWalkAnim(Direction.DOWN , Player.Action.PASSING_OUT , "16@1000, 0@500, 16@1000, 4@200, 5@6000");
        loadWalkAnim(Direction.UP   , Player.Action.PASSING_OUT , "16@1000, 0@500, 16@1000, 4@200, 5@6000");
        loadWalkAnim(Direction.RIGHT, Player.Action.PASSING_OUT , "16@1000, 0@500, 16@1000, 4@200, 5@6000");
        loadWalkAnim(Direction.LEFT , Player.Action.PASSING_OUT , "16@1000, 0@500, 16@1000, 4@200, 5@6000");

        loadWalkAnim(Direction.DOWN , Player.Action.USING_SCYTHE , "24@55, 25@45, 26@25, 27@25, 28@25, 29@25");
        loadWalkAnim(Direction.UP   , Player.Action.USING_SCYTHE , "36@55, 37@45, 38@25, 39@25, 40@25, 41@25");
        loadWalkAnim(Direction.RIGHT, Player.Action.USING_SCYTHE , "30@55, 31@45, 32@25, 33@25, 34@25, 35@25");
        loadWalkAnim(Direction.LEFT , Player.Action.USING_SCYTHE , "30@55, 31@45, 32@25, 33@25, 34@25, 35@25");

        loadWalkAnim(Direction.DOWN , Player.Action.WATERING , "54@75, 55@100, 25@500");
        loadWalkAnim(Direction.UP   , Player.Action.WATERING , "62@75, 63@100, 46@500");
        loadWalkAnim(Direction.RIGHT, Player.Action.WATERING , "58@75, 59@100, 45@500");
        loadWalkAnim(Direction.LEFT , Player.Action.WATERING , "58@75, 59@100, 45@500");
    }

    synchronized private void loadWalkAnim(Direction direction, Player.Action action, String data) {
        ...
        for (String entry : data.split(",")) {
            ...
            TextureRegion frame = loadTexture(direction, new int[]{row, column}, new int[]{row, column + 6},
    ...
    private TextureRegion loadTexture(Direction direction, int[] baseBody, int[] baseHand, int[] shirt, int[] pants, int[] hair) {
        ...
        int y = pixelsFromBottomToTopOpaque(baseFrames[baseBody[0]][baseBody[1]]) - baseHeight.get(direction);
        ...
        fbBatch.draw(shirtFrames[shirt[0]][shirt[1]], 4, y + 10);
        fbBatch.draw(baseFrames[baseHand[0]][baseHand[1]], 0, 0); //hand

        fbBatch.setColor(Color.BROWN);
        fbBatch.draw(hairFrames[hair[0]][hair[1]],0 ,y - 1);
    ...
    public TextureRegion getFrame(float stateTime, Vector2 dir, Player.Action action) {
        ...
        return animations.get(action).get(lastDir).getKeyFrame(stateTime / 2f, true);
    }
